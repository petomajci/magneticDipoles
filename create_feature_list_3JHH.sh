...
echo molecule
echo TARGET
echo min distance H1X,H2Y
echo max distance H1X,H2Y
echo min distance H1Y,H2X
echo max distance H1Y,H2X
echo distance HH
echo distance XY
echo min angle iXY,jYX
echo max angle iXY,jYX
echo "|torsion HXYH|"
echo X,Y=H
echo X,Y=C
echo X,Y=N
